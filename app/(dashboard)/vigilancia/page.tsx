            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-6">
                    <div className="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 rounded-xl overflow-hidden shadow-sm flex flex-col h-[500px]">
                        ...
                        <div className="relative flex-1 bg-slate-100 dark:bg-slate-800/50">
                            {/* Simulated Interactive Map */}
                            <div className="absolute inset-0 bg-cover bg-center opacity-80 mix-blend-multiply dark:mix-blend-screen" style={{ backgroundImage: "url('https://lh3.googleusercontent.com/aida-public/AB6AXuDwXtpaI37KDStYpMEHvZinegyyXDZl_AVuyzhPL3qo2eWQCzp8tsvz_B_MEk4tiUkZMEm0_H7BfNkEVGa4aVoO7DRIwZru9aH5BfxI1OK2tLWQe8mNp5EZroWI2geK8K6WbDTOaHbZKBXxBu1Qtc6S9nrShlPZ6gAYxFZPSvMUTfgtolgAbi4pYa1hBHdr1nHiB21lwTGIM4c4TIUrB1AlTYm6ELx56q2kbVuw7BeXv2p77F9Rj1FH2ymFWUUI9HT3LUtKPBMmeFPs')" }}></div>

                            {/* Map Controls */}
                            <div className="absolute top-4 right-4 flex flex-col gap-2">
                                <button className="bg-white dark:bg-slate-800 p-2 rounded-lg shadow-md border border-slate-200 dark:border-slate-700 hover:bg-slate-50 dark:hover:bg-slate-700 text-slate-600 dark:text-slate-300">
                            ...
                            {/* Data Point Popover Example */}
                            <div className="absolute top-1/2 left-1/3 bg-white dark:bg-slate-900 p-3 rounded-xl shadow-xl border border-red-500/50 max-w-[180px]">
                                <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Jiutepec</p>
                                <p className="text-sm font-black text-slate-900 dark:text-white mt-1">Cobertura: 62%</p>
                                <div className="mt-2 flex items-center gap-1.5 text-[10px] text-red-600 dark:text-red-400 font-black uppercase tracking-wider bg-red-50 dark:bg-red-900/20 px-2 py-1 rounded-lg">
